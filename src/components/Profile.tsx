...
import { Camera, MapPin, Star, TrendingUp, Users, Calendar, Plus, X } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {profileData.skillsOffered.map((skill, index) => (
                      <Badge key={index} className="animate-in fade-in-0 zoom-in-95 relative group">
                        {skill}
                        {isEditing && (
                          <Button
                            size="icon"
                  ...
                  {isEditing && (
                    <div className="flex mt-2">
                      ...
                      />
                      <Button size="icon" onClick={addSkillOffered}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {profileData.skillsWanted.map((skill, index) => (
                      <Badge key={index} variant="outline" className="animate-in fade-in-0 zoom-in-95 relative group">
                        {skill}
                        {isEditing && (
                          <Button
                            size="icon"
                  ...
                  {isEditing && (
                    <div className="flex mt-2">
                      ...
                      />
                      <Button size="icon" onClick={addSkillWanted}>
                        <Plus className="h-4 w-4" />
                      </Button>
                    </div>
                  )}
